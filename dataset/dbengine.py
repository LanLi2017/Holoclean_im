...
class DBengine:
    ...
    def execute_queries(self, queries):
        ...
        tic = time.clock()
        # check what happened here/.. Lan
        print(f'execute_queries in dbengine.py : {queries}')
    ...
    def execute_query(self, query):
        ...
        # check what happened... Lan
        print(f'check query in execute_query in dbengine.py : {query}')
