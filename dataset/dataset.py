...
class Dataset:
    ...
    def load_data(self, name, fpath, na_values=None, entity_col=None, src_col=None):
        ...
        try:
            ...
            if entity_col is None:
                ...
                # check entity column ... Lan
                print(f'entity column as tid column dataset.py : {entity_col}')
        ...
        for cond_attr in self.get_attributes():
            ...
            for trg_attr in self.get_attributes():
                if trg_attr != cond_attr:
                    ...
                    # check what here the pairing attributes are ...Lan
                    print(f'pairing attribute stats in dataset.py {self.pair_attr_stats}')
    ...
    def get_domain_info(self):
        ...
        # check ...Lan
        print(f'get_domain_info from dataset.py : result of query from cell_domain {res}')
    ...
    def get_repaired_dataset(self):
        ...
        repaired_df.to_csv('usecase1_repaired.csv')
